...
- [DevOps Bash tools](https://github.com/nholuongut/DevOps-Bash-tools) - Fully automated builds for Jenkins, Concourse and GoCD along with auto-loaded pipeline build configurations, and API scripts for all major CI systems

- [Templates](https://github.com/nholuongut/Templates) - templates for many CI systems, code and configs eg. Jenkinsfile, GitHub Actions, Travis CI, CircleCI, GCP Cloud Build, Makefile, Vagrantfile, Dockerfile, docker-compose.yml etc.


### All the CI Systems

All my [major GitHub repos](https://github.com/nholuongut) contain fully working live configs for just about every major CI system out there:
